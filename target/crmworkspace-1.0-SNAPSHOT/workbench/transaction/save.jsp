	...
	<script>
		...
		$(function (){
			...
			$("#create-stage").change(function() {
				...
				var stage = $("#create-stage").val();		// 或者this.value
...
<%--						</c:forEach>--%>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="小蜜蜂1">
				<input type="hidden" name="activityId" value="a556879c0e8447c9880c4d81eb985eab"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="238d3e336aac463e934128a6a6cc1e1b"/>
			</div>
		</div>
